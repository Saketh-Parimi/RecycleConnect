...
class AuthController extends GetxController with StateMixin {
  ...
  Rx<User> _user = User(username: '', password: '', id: '').obs;
  ...
  void loginUser(String username, String password) async {
    try {
      ...
      _user.value = await authService.loginUser(username, password);
  ...
  void registerUser(String username, String password) async {
    try {
      ...
      print(username);
      print(password);
      _user.value = await authService.registerUser(username, password);
